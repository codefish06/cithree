...
<html lang="ar" dir="rtl" data-bs-theme="auto">
  <head>
    ...
    />
    <script src="<?php echo base_url('application/assets/js/bootstrap_examples/color-modes.js'); ?>"></script>
    <link href="<?php echo base_url('application/assets/css/bootstrap.rtl.min.css'); ?>" rel="stylesheet" />
    <meta name="theme-color" content="#712cf9" />
    <link href="<?php echo base_url('application/assets/css/bootstrap_examples/cheatsheet.rtl.css'); ?>" rel="stylesheet" />
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
  ...
  <body class="bg-body-tertiary">
    ...
    >
      <div class="container-fluid d-flex align-items-center">
        <h1 class="d-flex align-items-center fs-4 text-white mb-0">
          <img
            src="<?php echo base_url('application/assets/images/bootstrap_examples/brand/bootstrap-logo-white.svg'); ?>"
            width="38"
            height="30"
            class="me-3"
            alt="Bootstrap"
    ...
    <script
      src="<?php echo base_url('application/assets/js/bootstrap.bundle.min.js'); ?>"
      class="astro-vvvwv3sm"
    ></script>
    <script src="<?php echo base_url('application/assets/js/bootstrap_examples/cheatsheet.js'); ?>" class="astro-vvvwv3sm"></script>
  </body>
</html>
