...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link href="<?php echo base_url('application/assets/css/bootstrap_examples/navbars-offcanvas.css'); ?>" rel="stylesheet" />
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
          ...
          <div class="col-sm-8 py-5 mx-auto">
            ...
            <p>
              <a
                ...
                href="../components/navbar#offcanvas"
                role="button"
                >Learn more about offcanvas navbars &raquo;</a
              >
            </p>
          </div>
        </div>
