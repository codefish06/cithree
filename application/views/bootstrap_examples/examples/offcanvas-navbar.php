...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link href="<?php echo base_url('application/assets/css/bootstrap_examples/offcanvas-navbar.css'); ?>" rel="stylesheet" />
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
  ...
  <body class="bg-body-tertiary">
    ...
    ></script>
    <script src="<?php echo base_url('application/assets/js/bootstrap_examples/offcanvas-navbar.js'); ?>" class="astro-vvvwv3sm"></script>
  </body>
</html>
