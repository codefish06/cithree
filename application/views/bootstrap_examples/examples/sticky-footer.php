...
<html lang="en" class="h-100" data-bs-theme="auto">
  <head>
    ...
    <link
      rel="canonical"
      href="https://getbootstrap.com/docs/5.3/examples/sticky-footer/"
    />
    ...
    <link href="<?php echo base_url('application/assets/css/bootstrap_examples/sticky-footer.css'); ?>" rel="stylesheet" />
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
