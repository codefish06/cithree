...
<html lang="ar" dir="rtl" data-bs-theme="auto">
  <head>
    ...
    <link href="<?php echo base_url('application/assets/css/bootstrap_examples/checkout.css'); ?>" rel="stylesheet" />
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
  ...
  <body class="bg-body-tertiary">
      ...
      <main>
        <div class="py-5 text-center">
          <img
            ...
            src="<?php echo base_url('application/assets/images/bootstrap_examples/brand/bootstrap-logo.svg'); ?>"
            alt=""
            width="72"
            height="57"
          />
    ...
    ></script>
    <script src="<?php echo base_url('application/assets/js/bootstrap_examples/checkout.js'); ?>" class="astro-vvvwv3sm"></script>
  </body>
</html>
