...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link href="<?php echo base_url('application/assets/css/bootstrap_examples/dropdowns.css'); ?>" rel="stylesheet" />
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
          ...
          <nav>
            <ul class="d-flex flex-column gap-2 list-unstyled small">
              <li>
                <a
                  href="#"
                  class="link-offset-2 link-underline link-underline-opacity-25 link-underline-opacity-75-hover"
                  >Documentation</a
                >
              </li>
              <li>
