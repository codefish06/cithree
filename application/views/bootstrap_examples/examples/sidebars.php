...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link href="<?php echo base_url('application/assets/css/bootstrap_examples/sidebars.css'); ?>" rel="stylesheet" />
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
  ...
  <body>
    ...
    ></script>
    <script src="<?php echo base_url('application/assets/js/bootstrap_examples/sidebars.js'); ?>" class="astro-vvvwv3sm"></script>
  </body>
</html>
