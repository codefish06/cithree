...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <link href="<?php echo base_url('application/assets/css/bootstrap_examples/navbars.css'); ?>" rel="stylesheet" />
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
  ...
  <body>
    ...
    <main>
      ...
      <div class="container-xl mb-4"><p>Matching .container-xl...</p></div>
      <nav
        class="navbar navbar-expand-lg navbar-dark bg-dark"
          ...
          <div class="bg-body-tertiary p-5 rounded">
            <div class="col-sm-8 mx-auto">
              ...
              <p>
                ...
                viewport, others are confined within a <code>.container</code>.
                For positioning of navbars, checkout the
                <a href="../examples/navbar-static/">top</a> and
